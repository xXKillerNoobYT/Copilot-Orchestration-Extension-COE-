...
export async function handleReportTestFailure(args) {
    // Validate input
    ...
    try {
        ...
        return formatAgentError(AgentErrors.operationFailed('report test failure', error instanceof Error ? error.message : String(error)));
    }
}
