...
describe('ToolSelector', () => {
  ...
  describe('Performance Metrics', () => {
    ...
    it('should consider latency in selection criteria', async () => {
  ...
  describe('Authentication-Based Selection', () => {
    it('should filter providers requiring authentication', async () => {
  ...
  describe('Permission-Based Selection', () => {
    it('should consider agent permissions', async () => {
