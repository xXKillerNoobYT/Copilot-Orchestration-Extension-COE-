...
// Import the compiled prompt cache (assuming it's available)
let PromptCache;
try {
  PromptCache = require('./dist/llm/promptCache').PromptCache;
} catch (e) {
  console.error('Could not load PromptCache. Make sure it is compiled first.');
  process.exit(1);
}
