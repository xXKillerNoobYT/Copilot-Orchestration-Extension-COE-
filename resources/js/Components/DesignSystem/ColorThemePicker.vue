  ...
  <div class="color-theme-picker">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      <div
        ...
        :key="theme.id"
        class="theme-card cursor-pointer border-2 rounded-lg p-4 transition-all duration-200 hover:shadow-lg"
        :class="{
      ...
      >
        <div class="flex items-center justify-between mb-3">
          ...
          <span v-if="currentTheme.id === theme.id" class="text-blue-500">✓</span>
        </div>
        ...
        <div class="text-xs text-gray-500 space-y-1">
          <div class="flex items-center gap-2">
            <div class="w-3 h-3 rounded" :style="{ backgroundColor: theme.background }"></div>
            <span>Background</span>
          </div>
          <div class="flex items-center gap-2">
            <div class="w-3 h-3 rounded border" :style="{ backgroundColor: theme.text }"></div>
            <span>Text</span>
          </div>
        </div>
      </div>
